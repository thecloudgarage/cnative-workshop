...
read -e -p "stemcell456PivnetUrl: " -i "https://network.pivotal.io/api/v2/products/stemcells-ubuntu-xenial/releases/579634/product_files/613151/download" \
  stemcell456PivnetUrl
read -e -p "stemcell456PivnetProductName: " -i "light-bosh-stemcell-456.98-aws-xen-hvm-ubuntu-xenial-go_agent.tgz" stemcell456PivnetProductName
read -e -p "stemcell621PivnetUrl: " -i "https://network.pivotal.io/api/v2/products/stemcells-ubuntu-xenial/releases/630534/product_files/667978/download" \
  stemcell621PivnetUrl
read -e -p "stemcell621PivnetProductName: " -i "light-bosh-stemcell-621.71-aws-xen-hvm-ubuntu-xenial-go_agent.tgz" stemcell621PivnetProductName
read -e -p "stemcell315PivnetUrl: " -i "https://network.pivotal.io/api/v2/products/stemcells-ubuntu-xenial/releases/626507/product_files/663626/download" \
  stemcell315PivnetUrl
read -e -p "stemcell315PivnetProductName: " -i "light-bosh-stemcell-315.179-aws-xen-hvm-ubuntu-xenial-go_agent.tgz" stemcell315PivnetProductName
