...
#GO TO network.pivotal.io and login 
#FIRST FROM THE RIGHT TOP CORNER OF YOUR PROFILE NAME > EDIT PROFILE > AND THE LAST LINE WILL SAY LEGACY API TOKEN

export pivnetToken=your-legacy-api-token

#FOR ACCEPTING EULAS.. SEE THE PRODUCT/STELLCELL URLS AND NOTE THE PRODUCT NAMES..SELECT THOSE FROM THE LIST
#AND THEN SELECT THE RELEASE AND AWS VERSION FOR IT
#CLICK TO DOWNLOAD
#ONCE DOWNLOAD STARTS., IT WILL POP A EULA ACCEPTANCE
#ONCE ACCEPTED, CANCEL THE DOWNLOAD
